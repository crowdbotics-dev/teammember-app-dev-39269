...
## Project Structure
    ...
    ├── teammember_app_dev_39269  # Django project configurations
...
1. Clone this repo and `cd teammember_app_dev_39269`
...
2. Clone this repo and `cd teammember_app_dev_39269`
